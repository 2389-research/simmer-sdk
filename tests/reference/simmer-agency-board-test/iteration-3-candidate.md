...
4. Infer paint brands from products: If you extract ANY Citadel paint → also extract "citadel" as paint_brand. If you extract ANY Vallejo paint → also extract "vallejo" as paint_brand.
...
EXAMPLE 2 (concepts + aesthetics + body areas):
...
EXAMPLE 3 (colors + models + factions):
