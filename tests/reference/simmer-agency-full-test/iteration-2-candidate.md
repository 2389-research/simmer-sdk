...
- Color references when no specific paint is named (e.g. "dark brown", "warm gold", "desaturated yellow", "off-white")
- Body areas of miniatures (e.g. "recesses", "raised edges", "face", "cloak", "shoulder pad", "trim", "base rim")
- Aesthetic styles (e.g. "grimdark", "display quality", "tabletop standard", "blanchitsu", "eavy metal", "clean style")
- Theory and concepts (e.g. "color temperature", "contrast", "focal point", "sub-assembly", "batch painting", "value sketch", "hue shifting", "color harmony", "saturation", "underpainting")
