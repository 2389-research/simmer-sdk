...
STEP 3 — VERIFY CORRECTIONS: Before returning, re-read STEP 1 and fix every entity name that matches a correction. Replace "chris baron"→"trovarion", "rhine oxide"→"rhinox hide", "mephisto red"→"mephiston red", etc.
