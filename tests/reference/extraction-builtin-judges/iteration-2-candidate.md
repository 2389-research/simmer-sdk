...
Example — if the transcript says "the butterfly wings need a warm glaze of mephiston red over the feathers, keep the cold shadows desaturated":
{{
  "entities": [
    {{"name": "glazing", "type": "technique"}},
    {{"name": "mephiston red", "type": "paint"}},
