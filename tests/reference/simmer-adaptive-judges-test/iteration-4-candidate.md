...
- color: named colors and compound color terms ("orange", "black", "dark brown", "warm gold", "cold gold", "cool blue", "off-white")
...
- "orange" → KEEP as {{"name": "orange", "type": "color"}} — a valid color name
- "warm gold" / "cold gold" / "dark brown" → KEEP as color — compound color terms
- "gold" alone, "yellow" alone, "brown" alone, "white" alone, "warm" alone, "cold" alone → DROP — too generic
...
REVIEW STEP — before outputting, go through your entity list and DELETE:
- Any entity that is a single generic word: gold, yellow, brown, white, warm, cold, edges, guide, painting, color, brush
- Any entity that is a spatial phrase: "darkest areas", "darkest spot", "upper edges", "broad side of the brush"
- Any studio/filming/personal/YouTube/Patreon references
- Any duplicate — if two entities refer to the same thing (feather/feathers, rhinox hide/rhine oxide, reflection/reflection placement), keep ONLY the most correct or most specific form
- Any entity not in the closed type set above
